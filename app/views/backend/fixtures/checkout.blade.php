...
{{-- Page title --}}
@section('title')
     @lang('admin/fixtures/general.checkout') ::
@parent
@stop
	...
	<div class="col-md-10 column">
		...
		<form class="form-horizontal" method="post" action="" autocomplete="off">
			...
			<div class="form-group {{ $errors->has('asset_id') ? ' has-error' : '' }}">
				<label for="asset_id" class="col-md-2 control-label">@lang('admin/fixtures/form.asset')
				 </label>
			...
			<div class="form-group {{ $errors->has('assigned_to') ? ' has-error' : '' }}">
				...
				<div class="col-md-9">
					...
					<p class="help-block">
					@lang('admin/fixtures/form.checkout_help')
					</p>
