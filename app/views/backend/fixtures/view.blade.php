				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group col-md-12">
							<div class="input-group col-md-12"><input class="col-md-12 form-control" type="text" name="notes" id="notes" placeholder="Notes"></div>
						</div>
						<div class="form-group col-md-12">
							<div class="input-group col-md-12">{{ Form::file('fixturefile[]', ['multiple' => 'multiple']) }}</div>
						</div>
					</div>
						...
						<tr>
							...
							<td>
								@if (($log->userlog) && ($log->userlog->id!='0'))
									<a href="{{ route('view/user', $log->checkedout_to) }}">{{{ $log->userlog->fullName() }}}</a>
	...
	<div class="col-md-3 col-xs-12 address pull-right">
		...
		<ul>
			...
			@if ($fixture->purchase_date > 0)
				<li><strong>@lang('admin/fixtures/form.date'):</strong>				{{{ $fixture->purchase_date }}} </li>
			@endif
			@if ($fixture->purchase_cost > 0)
				<li><strong>@lang('admin/fixtures/form.cost'):</strong>	@lang('general.currency') {{{ number_format($fixture->purchase_cost,2) }}} </li>
			@endif
