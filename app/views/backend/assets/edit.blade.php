...
@section('title')
    @if ($asset->id)
    	@lang('admin/assets/form.update') ::
    @else
    	@lang('admin/assets/form.create') ::
    @endif
@parent
@stop
...
<div class="row form-wrapper">
            ...
            <div class="col-md-12 column">
			 ...
			 @if ($asset->id)
				 <form class="form-horizontal" method="post" action="{{ route('update/assets',$asset->id) }}" autocomplete="off" role="form">
			 @else
				 <form class="form-horizontal" method="post" autocomplete="off" role="form">
			 @endif
            ...
            <div class="form-group {{ $errors->has('asset_tag') ? ' has-error' : '' }}">
                <label for="asset_tag" class="col-md-2 control-label">@lang('admin/assets/form.tag')
                 *</label>
                 </label>
            ...
            <div class="form-group {{ $errors->has('serial') ? ' has-error' : '' }}">
                <label for="serial" class="col-md-2 control-label">@lang('admin/assets/form.serial') *</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                <label for="name" class="col-md-2 control-label">@lang('admin/assets/form.name')</label>
                    <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('model_id') ? ' has-error' : '' }}">
                <label for="parent" class="col-md-2 control-label">@lang('admin/assets/form.model') *</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div id="mac_address" class="form-group {{ $errors->has('mac_address') ? ' has-error' : '' }}" style="display:none;">
                <label for="mac_address" class="col-md-2 control-label">@lang('admin/assets/form.mac_address')</label>
                    <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('purchase_date') ? ' has-error' : '' }}">
                <label for="purchase_date" class="col-md-2 control-label">@lang('admin/assets/form.date')</label>
            ...
            <div class="form-group {{ $errors->has('supplier_id') ? ' has-error' : '' }}">
                <label for="supplier_id" class="col-md-2 control-label">@lang('admin/assets/form.supplier')</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('order_number') ? ' has-error' : '' }}">
                <label for="order_number" class="col-md-2 control-label">@lang('admin/assets/form.order')</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('purchase_cost') ? ' has-error' : '' }}">
                    <label for="purchase_cost" class="col-md-2 control-label">@lang('admin/assets/form.cost') </label>
                    <div class="col-md-2">
            ...
            <div class="form-group {{ $errors->has('warranty_months') ? ' has-error' : '' }}">
                <label for="warranty_months" class="col-md-2 control-label">@lang('admin/assets/form.warranty')</label>
                <div class="col-md-2">
                    <div class="input-group">
                    <input class="col-md-2 form-control" type="text" name="warranty_months" id="warranty_months" value="{{{ Input::old('warranty_months', $asset->warranty_months) }}}" />   <span class="input-group-addon">@lang('admin/assets/form.months')</span>
            ...
            <div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
                <label for="status_id" class="col-md-2 control-label">@lang('admin/assets/form.status') *</label>
                    <div class="col-md-7 col-sm-12 col-sm-12">
                        ...
                        <p class="help-block">@lang('admin/assets/form.help_checkout')</p>
            ...
            <div id="assigned_user" style="display: none;" class="form-group {{ $errors->has('assigned_to') ? ' has-error' : '' }}">
                <label for="parent" class="col-md-2 control-label">@lang('admin/assets/form.checkout_to')
                 </label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('notes') ? ' has-error' : '' }}">
                <label for="notes" class="col-md-2 control-label">@lang('admin/assets/form.notes')</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('rtd_location_id') ? ' has-error' : '' }}">
                <label for="rtd_location_id" class="col-md-2 control-label">@lang('admin/assets/form.default_location')</label>
                    <div class="col-md-7 col-sm-12">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
				  <div class="checkbox">
					<label>
					  <input type="checkbox" value="1" name="requestable" id="requestable" {{ Input::old('requestable', $asset->requestable) == '1' ? ' checked="checked"' : '' }}> @lang('admin/assets/form.requestable')
					</label>
				  </div>
				</div>
		  	</div>
