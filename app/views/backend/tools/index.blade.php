...
<div class="row header">
    <div class="col-md-12">
        <a href="{{ route('create/tool') }}" class="btn btn-success pull-right"><i class="fa fa-plus icon-white"></i> @lang('general.create')</a>
        <h3>@lang('general.tools')</h3>
    </div>
</div>
...
<div class="user-profile">
    <div class="row profile">
        <div class="col-md-9 bio">
            {{ Datatable::table()
                ->addColumn(Lang::get('admin/tools/table.title'),
                ...
                ->setOptions(
                        array(
                            ...
                            'sAjaxSource'=>route('api.tools.list'),
                            'dom' =>'T<"clear">lfrtip',
                            'tableTools' => array(
